...
class Saver(object):
    ...
    def working(self, priority: int, url: str, keys: dict, deep: int, item: (list, tuple, dict)) -> (int, object):
        """
    ...
    def item_save(self, priority: int, url: str, keys: dict, deep: int, item: (list, tuple, dict)) -> (int, object):
        """
